...
export default function SALogs({ t, logs, pages, totals, changePage }) {
          ...
          <div className="divide-y divide-[#F1F5F9] min-w-[580px]">
            {filteredLogs.length === 0 ? (
              <div className="py-20 text-center">
                 ...
                 <div className="text-[#A0AEC0] font-bold text-[15px]">{search ? t("Natija topilmadi") : t("Loglar topilmadi")}</div>
              </div>
            ) : filteredLogs.map(l => {
